...
<!DOCTYPE html>
	...
	<!-- particles.js container --> <div id="particles-js"></div> <!-- stats - count particles --> <div class="count-particles"> <span class="js-count-particles"></span></div>	
	...
	<script type="text/javascript" src="<?php echo $this->baseurl . '/templates/jmarkos013/js/particles.js'; ?>">
	</script>
	<script type="text/javascript" src="<?php echo $this->baseurl . '/templates/jmarkos013/js/call.js'; ?>">
	</script>
</html>
